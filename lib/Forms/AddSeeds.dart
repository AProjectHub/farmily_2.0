...
class AddSeedsSaplingsScreen extends StatefulWidget {
  static const String screenId = 'Seeds and saplings';

  @override
  _AddSeedsSaplingsScreen createState() => _AddSeedsSaplingsScreen();
}

class _AddSeedsSaplingsScreen extends State<AddSeedsSaplingsScreen> {
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final DatabaseReference othersRef = database.child('SeedsSaplings').push();
